...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $products = [
            ...
            ['name' => 'Tarjeta de Red', 'description' => 'Tarjeta de red de alta velocidad', 'price' => 20.00, 'quantity' => 50],
            ['name' => 'Tarjeta de Juego', 'description' => 'Tarjeta de juego de alta calidad', 'price' => 20.00, 'quantity' => 50],
